...
class PlayerDryingManager : MonoBehaviour, ITickable {
    // Drying
    ...
    private int _dryingPointsCounter;
    ...
    private bool _firstMessageSkip = true;
    
    // Reactive 
    private List<Action> _unsubscribeHooks;
    ...
    private void EnterWet() {
        ...
        // if (_firstMessageSkip == true) {
        //     _firstMessageSkip = false;
        //     return;
        // }
